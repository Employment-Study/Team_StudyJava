...
public class Ex08 {
	public static void main(String[] args) {
		// Map : 	Key와 Value를 1대 1 맵핑하여 저장한다.
		...
		// key를 알면 value를 구할 수 있으나, value를 안다고 해서 Key를 구할 수 없다.
		...
		// map에서 key의 모음 혹은 value의 모습을 추출할 수는 있다.
		...
		while(it.hasNext()) {
			...
			System.out.println(key + " : "+value); 	// key에 맞는 value를 구하고
		}
		System.out.println();
		
		// 만약, 잘못된 key를 넣었을 경우 null 대신 다른 값을 기본 값으로 사용할 수 있다.
